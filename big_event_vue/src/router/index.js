...
const routes = [
    ...
    {path:'/',component:LayoutVue,redirect:'/show/manage',
        ...
        {path:'/conservation/disease',component:()=>import('@/views/article/conservation/DiseaseSurvey.vue')},
        {path:'/conservation/archive',redirect:'/conservation/project/1/archive'},
        {path:'/conservation/process',redirect:'/conservation/project/1/process'},
        {path:'/conservation/compare',redirect:'/conservation/project/1/comparison'},
        {path:'/conservation/result',redirect:'/conservation/project/1/restoration'},
        {path:'/conservation/monitor',redirect:'/conservation/project/1/monitoring'},
        {path:'/conservation/project/:projectId/archive',component:()=>import('@/views/article/conservation/Archive.vue')},
        {path:'/conservation/project/:projectId/disease',component:()=>import('@/views/article/conservation/DiseaseSurvey.vue')},
        {path:'/conservation/project/:projectId/process',component:()=>import('@/views/article/conservation/Process.vue')},
        {path:'/conservation/project/:projectId/comparison',component:()=>import('@/views/article/conservation/Compare.vue')},
        {path:'/conservation/project/:projectId/restoration',component:()=>import('@/views/article/conservation/Result.vue')},
