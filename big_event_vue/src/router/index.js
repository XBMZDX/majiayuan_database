...
const routes = [
    ...
    {path:'/',component:LayoutVue,redirect:'/show/manage',
        ...
        {path:'/conservation/project/:projectId/monitoring',component:()=>import('@/views/article/conservation/Monitor.vue')},
         ...
         {path:'/archive/catalog',component:DigitalArchive},
         {path:'/archive/files',component:DigitalArchive},
         {path:'/archive/media',component:DigitalArchive},
         {path:'/archive/models',component:DigitalArchive},
         {path:'/archive/research',component:DigitalArchive},
