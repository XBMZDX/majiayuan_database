...
public class DigitalMediaController {
    ...
    @Mapper interface MediaMapper {
        ...
        @Select("SELECT r.*, m.* FROM digital_resource r LEFT JOIN digital_media_metadata m ON m.resource_id=r.id WHERE r.id=#{id}")
